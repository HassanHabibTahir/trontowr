...
<header className="header">
            ...
            <div className="container container__header">
                    <div className="total_staked m-none" >
                    ...
                    */}
                    ...
                    <img className="animate1 m-none" src="/static/img/png/23.png" alt=""/>
                    ...
                    <div className="progress">
                        ...
                        <button className="button purple"   onClick={DetailsHandler} > details <img
                        ...
                        <div className="mining-block">
                            <div className="mining__list">
                                ...
                                <div className="mining__item mining__item--green">
                                    ...
                                    {/* @click="select_token = 'tth'" v-if="active" */}
                                        <button className="button green">stake tth
                            ...
                            <div className="panel__right">
                                ...
                                withdraw tokens <img src="/static/img/svg/arrow.svg" alt=""/>
                                    ...
                                    <a href="#" 
                                     className="text-blue">Statistics</a></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer>
            <div className="container">
                ...
                <div className="soc">
                    ...
                    <li><a 
                     href="#" onClick={openShareLanguageHandler}>
                    <img src="/static/img/svg/main/tl.svg" alt=""/>
                </a></li>
                    <li><a href="#" 
                     className="lang" onClick={HandlerFlagmenu} >
                    <img src="/static/img/flags/en.png" alt=""/>
                </a></li>
                </div>
            ...
            <div class="modal__container" style={{maxWidth:"500px"}}>
                ...
                <div class="modal-content">
                    <div class="container modal-login">
                        ...
                        <div>
                            <a href="#"  class="button green">tron link</a>
                            <a href="#"  class="button blue">tron wallet</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <img src="/static/img/svg/main/close.svg" alt=""/></button>
                <div className="container">
                    <ul>
                        ...
                        <li><a href="#"><img src="/static/img/flags/zh-hans.png"
                                                                             alt=""/></a><span>中文</span></li>

                        <li><a href="#"><img src="/static/img/flags/ru.png"
                                                                             alt=""/></a><span>Русский</span></li>

                        <li><a href="#"><img src="/static/img/flags/fa.png"
                                                                             alt=""/></a><span>farsi</span></li>

                        <li><a href="#"><img src="/static/img/flags/es.png"
                                                                             alt=""/></a><span>espanol</span></li>

                        <li><a href="#"><img src="/static/img/flags/vi.png"
            ...
            <div className="modal__container modal-menu">
                ...
                <div className="container">
                    <div className="wallet_info">
                        ...
                        <button className="button green" v-if="!user" 
                         onClick={togleSignUpMenu} >login</button>
                    </div>
                    <menu>
                        <li><a href="#" >trade swd</a></li>
                        <li><a  href="#">whitepaper</a></li>
                        <li><a  href="#">diceshark</a></li>
                        <li><a  href="#">sharktron</a></li>
